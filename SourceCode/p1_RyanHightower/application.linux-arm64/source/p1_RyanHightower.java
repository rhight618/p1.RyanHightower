...
public class p1_RyanHightower extends PApplet {
...
public void doorButton(int x, int y, String s){
...
public void presetTimeDisplay(int x, int y, int id){
...
public void timedHeatingButton(int x, int y, String s){
...
public void presetButton(int x, int y, String s, int id){
...
public void setPresetButton(int x, int y, String s){
...
public void enterButton(int x, int y, String s){
...
public void letteredButton(int x, int y, String s){
...
public void numberedButton(int x, int y, String s){
...
public void clearButton(int x, int y, String s){
  int size = 20;
  int offset = size + 25;
...
public void startButton(int x, int y, String s){
  int size = 20;
  int offset = size + 10;
...
public void timerDisplayUpdate(String s){
  timerDisplayText=s;
}

public void resetPresetTime(int id){
  presetTimes.set(id,"");  
}

public void setPresetTime(int id, String number){  
  String time = getPresetTime(id);
  time+=number;
  presetTimes.set(id,time);   
}

public String getPresetTime(int id){
  return presetTimes.get(id);    
}

public int getPresetTimeLengthById(int id){
  String time = getPresetTime(id);
  return time.length();
}

//converts seconds to hours:minutes:seconds for display
public String getDisplayTimeFromString(String time){
...
public String padWithZeros(int time){
...
public void resetPresetName(int id){
  presetNames.set(id,""); 
}

public void setPresetName(int id, String letter){
...
public String getPresetName(int id){
  ...
  public void settings() {  size(520,720); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "p1_RyanHightower" };
    if (passedArgs != null) {
